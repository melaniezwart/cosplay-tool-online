...
INSERT INTO cto.CTO_LOGIN(username, password, cto_user_id) VALUES
('testuser1', md5('testpass1'), 1),
('testuser2', md5('testpass2'), 2),
('testuser3', md5('testpass3'), 3),
('testuser4', md5('testpass4'), 4),
('testuser5', md5('testpass5'), 5),
('testuser6', md5('testpass6'), 6);
